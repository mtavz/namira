(function($){
  ...
  function initOwlCarousel(){
    ...
    $("#owl-hero").owlCarousel({
      ...
      nav:true,
      navSpeed: 10,
      navText: ['<i class="zmdi zmdi-caret-left">','<i class="zmdi zmdi-caret-right>']
    });
    ...
    $("#owl-single").owlCarousel({
      ...
      nav:true,
      animateOut: 'fadeOut',
      navText: ['<i class="zmdi zmdi-caret-right">','<i class="zmdi zmdi-caret-right">']
    });
...
/*==================================================================
  ...
  /* Sign In Popup
  -------------------------------------------------------*/
  $('.product__quickview').magnificPopup({
    type: 'ajax',
    alignTop: false,
    overflowY: 'scroll',
    removalDelay: 300,
